                ...
                modalOpen ? (
                            ...
                            >
                                <div className="containerModal">
                                    ...
                                    <p className="dataMarcada">Data Marcada : {events[1] ? events[1].start.toLocaleDateString("en-US") : 'error'}    </p>
                                    <button className="handleAddEvent" onClick={toggleModal}>Fechar</button>
                                </div>
                            </Modal>
